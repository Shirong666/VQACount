...
class TextProcessor(nn.Module):
    def __init__(self, embedding_tokens, embedding_features, lstm_features, drop=0.0):
        ...
        self.multihead_attn = nn.MultiheadAttention(embedding_features, config.head_text_attention, batch_first=True)
    ...
    def forward(self, q, q_len):
        ...
        attn_output, attn_output_weights = self.multihead_attn(tanhed,tanhed,tanhed)
